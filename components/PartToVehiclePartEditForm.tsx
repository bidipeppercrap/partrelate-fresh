...
export default function PartToVehiclePartForm({
    ...
    onSave: (assignedPart: PartToVehiclePart) => Promise<void>;
}) {
    ...
    const selectedPart = useSignal<Part | null>(assignedPart.parts || null);

    const partValue = useSignal(assignedPart.parts ? assignedPart.parts.name : "");
